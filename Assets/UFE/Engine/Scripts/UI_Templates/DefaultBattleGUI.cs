...
public class DefaultBattleGUI : BattleGUI{
	...
	public override void DoFixedUpdate(
		...
		if (this.isRunning){
			...
			if (temp >= 0.1f)
			{
				player1.controlsScript.currentGaugesPoints[0] += UFE.config.player1Character.maxGaugePoints / 8 / 10;
				player2.controlsScript.currentGaugesPoints[0] += UFE.config.player2Character.maxGaugePoints / 8 / 10;
				temp = 0;
			}
	...
	protected override void OnRoundBegin(int roundNumber){
		...
		player1.controlsScript.currentGaugesPoints[0] = UFE.config.player1Character.maxGaugePoints;
		player2.controlsScript.currentGaugesPoints[0] = UFE.config.player2Character.maxGaugePoints;
	}
